var Player1 = function(settings) {
    ...
    //player cannot move pass map walls
    ...
    function MoveSqr(){
      if(turn.turnNum==1){   //setting the moveSqr with initial coordinate
        if(coord.y_bottom > (32 + moveSqr + Int.Height)){
          playerElement.style.top = 32 + moveSqr + 'px';
        }

        if(coord.x_right > (200 + moveSqr + Int.Width)){
          playerElement.style.left = 200 + moveSqr + 'px';
        }
    ...
    function checkItemEffect(playerBags){
      playerBags[0].forEach(function(el,i,a){
        switch(el.name){
          case "Machine Gun":
            canAttack = true;
            break;
          ...
          case "Spider":
            ...
            a.splice(i,1);
            break;
          // case "Teleportation Book":
          //   playerElement.style.top = 13*32 + 32 + "px";
          //   playerElement.style.left = 3*32 +200 +"px";
          //   a.splice(i,1);
          //   removeElement('showMove1');
          //   create(turn);
          //   break;
    ...
    function init(){
      playerElement = document.getElementById('hero1');

      playerElement.style.background = "url('./assets/girlCharacter.png') 0px 0px";
